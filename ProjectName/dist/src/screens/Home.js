...
const StarAccount_1 = __importDefault(
  require('../features/accountCard/StarAccount'),
);
const TransactionList_1 = __importDefault(
  require('../features/transactionList/TransactionList'),
);
const ServiceMessages_1 = __importDefault(
  require('../features/serviceMessages/ServiceMessages'),
);
...
const BlurScreen_1 = __importDefault(
  require('../components/BlurScreen/BlurScreen'),
);
const hooks_1 = require('../store/hooks');
const Avatars_constant_1 = require('../constants/Avatars.constant');
...
const Home = () => {
  ...
  (0, react_1.useEffect)(() => {
    const appStateListener = react_native_2.AppState.addEventListener(
      'change',
      nextAppState => {
    ...
    return () => {
      appStateListener === null || appStateListener === void 0
        ? void 0
        : appStateListener.remove();
    };
  }, []);
  const [appState, setAppState] = (0, react_1.useState)(
    react_native_2.AppState.currentState,
  );
  ...
  return react_1.default.createElement(
    react_native_1.SafeAreaView,
    {
      style:
        darkmode == 'dark'
          ? DarkModeStyle_1.default.container
          : styles.container,
    },
    ...
    react_1.default.createElement(QuickPay_1.default, {
      payAccounts: Avatars_constant_1.Avatars,
    }),
    ...
    appState != 'active'
      ? react_1.default.createElement(BlurScreen_1.default, null)
      : null,
  );
};
