...
const Tab = ({ monthData, Ref, DATA, scrollA, }) => {
    ...
    return (react_1.default.createElement(react_native_1.Animated.View, { style: {
        ...
        react_1.default.createElement(react_native_1.Animated.FlatList, { data: monthData, horizontal: true, renderItem: ({ item }) => {
                return (react_1.default.createElement(react_native_1.Pressable, { onPress: () => {
                    ...
                    react_1.default.createElement(react_native_1.Text, { style: (item === null || item === void 0 ? void 0 : item.month) == monthTab
